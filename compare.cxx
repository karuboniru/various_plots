...
int main(int argc, char *argv[]) {
    ...
    for (const auto &[channelname, title] : resevent2.single_pion_channels) {
        ...
        plot_compare(resevent2.p_all.Qhistograms[channelname].get(), resevent2.p_cut.Qhistograms[channelname].get(),
                     hybrid.p_all.Qhistograms[channelname].get(), output_prefix, xsecp);
        plot_compare(resevent2.p_all.Whistograms[channelname].get(), resevent2.p_cut.Whistograms[channelname].get(),
                     hybrid.p_all.Whistograms[channelname].get(), output_prefix, xsecp);
        plot_compare(resevent2.p_all.Ehistograms[channelname].get(), resevent2.p_cut.Ehistograms[channelname].get(),
                     hybrid.p_all.Ehistograms[channelname].get(), output_prefix, {0, 0, 0.});
        plot_compare(resevent2.p_all.p_mu[channelname].get(), resevent2.p_cut.p_mu[channelname].get(), hybrid.p_all.p_mu[channelname].get(), output_prefix,
                     xsecp);
        plot_compare(resevent2.p_all.pl_mu[channelname].get(), resevent2.p_cut.pl_mu[channelname].get(), hybrid.p_all.pl_mu[channelname].get(), output_prefix,
                     xsecp);
        plot_compare(resevent2.p_all.pt_mu[channelname].get(), resevent2.p_cut.pt_mu[channelname].get(), hybrid.p_all.pt_mu[channelname].get(), output_prefix,
                     xsecp);
        plot_compare(resevent2.p_all.angle_mu[channelname].get(), resevent2.p_cut.angle_mu[channelname].get(), hybrid.p_all.angle_mu[channelname].get(),
                     output_prefix, xsecp);
    }
    return 0;
}