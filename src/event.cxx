...
std::size_t event::get_pi0_count() const
{
    return get_count(111);
}

std::size_t event::get_pip_count() const
{
    return get_count(211);
}

std::size_t event::get_pim_count() const
{
    return get_count(-211);
}

std::size_t event::get_pions() const
{
    return get_pip_count() + get_pim_count() + get_pi0_count();
}
