...
int main(int argc, const char **argv) {
  ...
  objs_list
      .emplace_back(dataset_2pi.Histo1D(
          {"W_2pi", "W(2#pi) ; #it{W} (GeV); Count (1/GeV)", 128u, 0, 0},
          "W_pion_system"))
      ->Scale(1. / count_all, "WIDTH");
  objs_list
      .emplace_back(dataset_2pi_bc.Histo1D(
          {"W_2pi_noce",
           "W(#pi^{+}#pi^{-}/ 2#pi^{0}) ; #it{W} (GeV); Count (1/GeV)", 128u, 0,
           0},
          "W_pion_system"))
      ->Scale(1. / count_all, "WIDTH");
  objs_list
      .emplace_back(dataset.Histo1D({"W_all", "", 128u, 0, 0}, "W_pion_system"))
      ->Scale(1. / count_all, "WIDTH");
  objs_list
      .emplace_back(dataset_2pi.Histo1D(
